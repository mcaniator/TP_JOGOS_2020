...
{
    //COMANDOS TECLADO
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::Left) && sentidoMovimentoY == 0 && !sf::Keyboard::isKeyPressed(sf::Keyboard::Right) && direcao != 'e' && corpoJogador.getPosition().x - corpoJogador.getSize().x / 2 > BORDA_ESQ && vivo)
    {
        sentidoMovimentoX = -1;
        velocidadeX = velMax;
    }
    else if(sf::Keyboard::isKeyPressed(sf::Keyboard::Right) && sentidoMovimentoY == 0 && !sf::Keyboard::isKeyPressed(sf::Keyboard::Left) && direcao != 'd' && corpoJogador.getPosition().x + corpoJogador.getSize().x / 2 < BORDA_DIR && vivo)
    {
        sentidoMovimentoX = 1;
        velocidadeX = velMax;
    }
    ...
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::Up) && sentidoMovimentoX == 0 && !sf::Keyboard::isKeyPressed(sf::Keyboard::Down) && direcao != 'c' && corpoJogador.getPosition().y - corpoJogador.getSize().y / 2 > BORDA_SUP && vivo)
    {
        sentidoMovimentoY = -1;
        velocidadeY = velMax;
    }
    else if(sf::Keyboard::isKeyPressed(sf::Keyboard::Down) && sentidoMovimentoX == 0 && !sf::Keyboard::isKeyPressed(sf::Keyboard::Up) && direcao != 'b' && corpoJogador.getPosition().y + corpoJogador.getSize().y / 2 < BORDA_INF && vivo)
    {
        sentidoMovimentoY = 1;
        velocidadeY = velMax;
    }
